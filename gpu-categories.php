...
<head>
    ...
    <script>
        function applySort() {
            ...
            window.location.href = 'gpu-categories.php?sort=' + sort;
        }
    </script>
</head>
<body>
        ...
        <div class="container">
            <div class="even-flex padding-block">
                <div class="path fw-light fs-normal text-neutral">
                    <a href="homepage.php">Home</a> > <a href="homepage.php">Categories</a> > <div class="fw-bold">Graphics Processing Unit</div>
                </div>
            ...
            <?php foreach ($rows as $row) : ?>
                <div class="ram-card">
                    <div class="ram-card-content">
                        <h2 class="ram-card-title fw-bold text-neutral fs-normal"><?php echo htmlspecialchars($row['gpu_name']); ?></h2>
                        <img src="img/<?php echo htmlspecialchars($row['gpu_image']); ?>" alt="<?php echo htmlspecialchars($row['gpu_name']); ?>" class="ram-card-image">
                        <div class="ram-card-detail">
                            <p class="text-neutral fw-regular">
                                Chipset: <?php echo htmlspecialchars($row['gpu_chipset']); ?>
                            </p>
                            <p class="text-neutral fw-regular">
                                Memory Size: <?php echo htmlspecialchars($row['gpu_memory_size']); ?>
                            </p>
                            <p class="text-neutral fw-regular">
                                Base Clock: <?php echo htmlspecialchars($row['gpu_base_clock']); ?> MHz
                            </p>
                            <p class="text-neutral fw-regular">
                                Boost Clock: <?php echo htmlspecialchars($row['gpu_boost_clock']); ?> MHz
                            </p>
                            <p class="text-neutral fw-regular">
                                Shaders: <?php echo htmlspecialchars($row['gpu_shaders']); ?>
                            </p>
                            <p class="text-neutral fw-regular">
                                Brand: <?php echo htmlspecialchars($row['gpu_brand']); ?>
                            </p>
                            <p class="text-neutral fw-regular">
                                Date Released: <?php echo htmlspecialchars($row['gpu_date']); ?>
                            </p>
                            <p class="text-neutral fw-regular">
                                Price: PHP <?php echo htmlspecialchars(number_format($row['gpu_price'], 2)); ?>
                            </p>
                        </div>
